...
struct MCDataUtilSettings {
    ...
    std::string customVocabFile;
    std::string dataBase;
    std::string graphLogs;
    std::string mapLogs;
   ...
   */
    ...
    // cfg variable that mentions the type of IMU used during mapping, needed for cross IMU relocalization
    int ImuMapFrame;
};
