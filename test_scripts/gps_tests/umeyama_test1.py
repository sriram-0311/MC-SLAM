...
def plot_3_sets(points1, points2, points3, colour1, colour2, colour3):
    ...
    ax.legend(['pointsetB_umeyama', 'pointset A', 'pointsetB_orig'])
...
# plot_3_sets(pointset1, pointset2[1:], pointset1, 'g', 'r', 'g')
fig = plt.figure()
ax = fig.add_subplot(111, projection='3d')
ax.scatter(pointset1[:, 0], pointset1[:, 1], pointset1[:, 2], c='b')
ax.scatter(pointset2[1:][:, 0], pointset2[1:][:, 1], pointset2[1:][:, 2], c='r')
